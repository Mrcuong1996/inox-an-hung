...
const SplitNotFoundComponent = () => /* @__PURE__ */ jsxs("div", { className: "min-h-screen bg-background", children: [
  ...
  /* @__PURE__ */ jsxs("div", { className: "container-page py-32 text-center", children: [
    /* @__PURE__ */ jsx("h1", { className: "font-display text-3xl", children: "Không tìm thấy sản phẩm" }),
    /* @__PURE__ */ jsx(Link, { to: "/san-pham", className: "mt-6 inline-block text-accent", children: "← Quay lại danh sách" })
  ] })
] });
export {
